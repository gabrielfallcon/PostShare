            ...
            <>
                <div className="corpo">
                    <div className="pai">
                        ...
                        <hr className="my2" />
                        <h5>Compartilhe com suas redes</h5>
                        <div className="sharer">
                            ...
                            <a href={`https://facebook.com/sharer/sharer.php?u=www.verzel.com.br&quote=${coment}`} class=" btn text-primary ml-5    "><FontAwesomeIcon icon={faFacebook} size="1x"></FontAwesomeIcon>Compartilhar </a>
                            <a href={`https://twitter.com/intent/tweet?url=www.verzel.com.br&text=${coment}`} class=" btn text-primary ml-5 "><FontAwesomeIcon icon={faTwitter} size="1x"></FontAwesomeIcon>Compartilhar</a>
                        </div>
                    </div>
                </div>
            </>
